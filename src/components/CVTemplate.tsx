...
export const CVTemplate = forwardRef<HTMLDivElement>((_, ref) => {
  const { personalInfo, experiences, skills, languages } = cvData;
  ...
  return (
    ...
    >
      ...
      <header className="relative border-b-2 pb-4 mb-5 py-5 space-y-4">
        <div>
          <h1 className="text-3xl font-light uppercase">{personalInfo.name}</h1>
      ...
      <div className="w-full flex">
        <aside className="flex-1 pr-4 border-r border-gray-300">
          ...
          <section>
            ...
            <div className="flex flex-col gap-y-1 mt-5 text-sm text-gray-600">
              ...
              {/* <span className="flex items-baseline gap-2">
                <FaLinkedinIn /> {personalInfo.linkedin}
              </span> */}
              <span className="flex items-center gap-2">
                <FaLink />
          ...
          <section className="mt-5">
            ...
            <div className="flex flex-col gap-y-1 mt-5 text-sm text-gray-600">
              ...
              <span>University of Valencia (Spain)</span>
              <span className="text-xs text-gray-500">2010 - 2015</span>
            </div>
            <div className="flex flex-col gap-y-1 mt-5 text-sm text-gray-600">
        ...
        <main className="pl-4 flex-2">
          ...
          <section>
            ...
            <p className="text-gray-600 text-sm mt-5">{personalInfo.profile}</p>
          </section>
          {/* Experience */}
          <section className="mt-5">
                ...
                <div key={idx}>
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-sky-900 font-medium">{exp.company}</p>
                    </div>
